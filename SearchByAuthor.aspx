<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchByAuthor.aspx.cs" Inherits="Book_Gallery.WebForm9" %>
    ...
    <div class="left-comp">
        ...
        <div class="right-comp">
            <div class="searchInput">
                <input class="form-control mr-sm-2" id="authorName" runat="server" type="search" placeholder="Search By Author Name" aria-label="Search" />
