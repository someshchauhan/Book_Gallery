<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchById.aspx.cs" Inherits="Book_Gallery.WebForm7" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="right-comp">
            <div class="searchInput">
                <input class="form-control mr-sm-2" id="bookId" runat="server" type="number" placeholder="Search By Id" aria-label="Search" />
